...
MKINSTALLDIRS   := /data/data/com.termux/files/usr/bin/mkdir -p
...
PKGCONFIG_REQUIRES         := 
PKGCONFIG_REQUIRES_PRIVATE := zlib, libpng, harfbuzz >= 2.0.0, libbrotlidec
PKGCONFIG_LIBS             := -L${libdir} -lfreetype
PKGCONFIG_LIBS_PRIVATE     := -lbz2
LIBSSTATIC_CONFIG          := -lfreetype -L/data/data/com.termux/files/usr/lib -lz -lbz2 -L/data/data/com.termux/files/usr/lib -lpng16 -lm -lz -lm -lz -L/data/data/com.termux/files/usr/lib -L/usr/local/lib -L/data/data/com.termux/files/usr/lib -lharfbuzz -pthread -lm -lfreetype -lbz2 -lpng16 -lm -lz -lm -lz -lbrotlidec -lbrotlicommon -lglib-2.0 -latomic -lm -liconv -pthread -lpcre2-8 -lgraphite2 -L/data/data/com.termux/files/usr/lib -lbrotlidec -lbrotlicommon
build_libtool_libs         := 
ft_version                 := 26.2.20
